    ...
    <div className='group-8'>
        <div className='mt-0'>
            ...
            <div className='group-7'>
                <div className=' border border-transparent border-b-white mt-1'id='inputs'>
                    <input 
                ...
                <button onClick={onSubmit} className='bg-white text-black w-28 rounded-sm p-2' id='btn'>Signup</button>
            </div>
        </div>
    </div>
  )
